          ...
          <div class="w-screen justify-center">
            <div 
                ...
                <div class="gap-8 lg:gap-20 flex justify-center items-center ml-5">
                    ...
                    <a href="https://maps.google.com/?q=YourLocationHere" class="flex items-center gap-2">
                        <p>Map</p>
